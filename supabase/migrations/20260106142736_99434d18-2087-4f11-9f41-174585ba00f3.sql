-- Fix the create_plan_version_snapshot function to handle version conflicts properly
...
DECLARE
  ...
  _snapshot JSONB;
BEGIN
  -- Get next version number with FOR UPDATE lock to prevent race conditions
  ...
  -- Insert new manual version with conflict handling
...
-- Also fix the auto backup function to handle conflicts
